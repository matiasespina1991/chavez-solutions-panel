...
interface ConfiguratorServicesTabProps {
  groupedServicesForRender: SelectedServiceGroup[];
  isLoadingAvailableServices: boolean;
  handleOpenMatrixSelectorDialog: () => void;
  comboEditServicesButtonClass: string;
  ...
  handleUpdateGroupName: (groupId: string, value: string) => void;
  handleOpenRemoveGroupDialog: (group: SelectedServiceGroup) => void;
  serviceUnderlineInputClass: string;
  ...
  handleOpenRemoveService: (groupId: string, service: SelectedService) => void;
  estimatedCostsSectionRef: RefObject<HTMLDivElement | null>;
  renderEstimatedCostsPanel: () => ReactNode;
  renderTabActions: () => ReactNode;
  shouldShowFloatingEstimatedCosts: boolean;
}
